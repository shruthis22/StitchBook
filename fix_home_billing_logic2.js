...
const e = code.indexOf(")).unwrap().catch(e => console.error(\"Stock err:\", e));\n      }", s);

if (s !== -1 && e !== -1) {
    const endStr = ")).unwrap().catch(e => console.error(\"Stock err:\", e));\n      }";
    ...
    code = code.substring(0, s) + newLogic + code.substring(e + endStr.length);
